...
public final class TxOuterClass extends com.google.protobuf.GeneratedFile {
    ...
    private int computeSerializedSize_0() {
      ...
      if (((bitField0_ & 0x00000001) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          ...
          {
            final int count = extensionOptions_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(extensionOptions_.get(i));
            }
            size += 2 * count;
          }

          {
            final int count = nonCriticalExtensionOptions_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(nonCriticalExtensionOptions_.get(i));
            }
            size += 2 * count;
          }
      return size;
  ...
  private static final long serialVersionUID = 0L;
    ...
    private int computeSerializedSize_0() {
      int size = 0;
          ...
          {
            final int count = signerInfos_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(signerInfos_.get(i));
            }
            size += 1 * count;
          }
      if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private int computeSerializedSize_0() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          size += com.google.protobuf.CodedOutputStream
            ...
            {
              final int count = modeInfos_.size();
              for (int i = 0; i < count; i++) {
                size += com.google.protobuf.CodedOutputStream
                  .computeMessageSizeNoTag(modeInfos_.get(i));
              }
              size += 1 * count;
            }
        return size;
  ...
  static {
    ...
    internal_static_cosmos_tx_v1beta1_ModeInfo_Single_descriptor =
      internal_static_cosmos_tx_v1beta1_ModeInfo_descriptor.getNestedType(0);
    internal_static_cosmos_tx_v1beta1_ModeInfo_Single_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_cosmos_tx_v1beta1_ModeInfo_Single_descriptor,
        new java.lang.String[] { "Mode", });
    internal_static_cosmos_tx_v1beta1_ModeInfo_Multi_descriptor =
      internal_static_cosmos_tx_v1beta1_ModeInfo_descriptor.getNestedType(1);
